...
import DeletePost from "../../components/Edits/Post/DeletePost";
import EditPost from "../../components/Edits/Post/EditPost";
...
export default function Post() {
  ...
  const handleDeletePostOpen = () => setIsDeletePostOpen(true);
  const handleCloseDeletePost = () => setIsDeletePostOpen(false);

  const [isEditPostOpen, setIsEditPostOpen] = useState(false);
  const handleEditPostOpen = () => setIsEditPostOpen(true);
  const handleCloseEditPost = () => setIsEditPostOpen(false);
  const columns = [
    {
      title: "STT",
      dataIndex: "stt",
    ...
    <>
      <div className="w-full">
        ...
        <div className="">
          ...
          />
          <EditPost isOpen={isEditPostOpen} onClose={handleCloseEditPost} />
        </div>
