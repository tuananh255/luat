...
interface EditCustomerTalkProps {
  onClose?: () => void;
  isOpen?: boolean;
}

const EditCustomerTalk: React.FC<EditCustomerTalkProps> = ({
  onClose,
  isOpen,
}) => {
          ...
          <div className="flex-col justify-center items-start gap-[17px] flex w-full">
            <div>
              <strong className="text-[18px]">
                Chỉnh sửa "Khách hàng nói gì về Apolo Lawyers"
              </strong>
            </div>
...
export default EditCustomerTalk;
