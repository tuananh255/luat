...
const EditFeatures: React.FC<EditFeaturesProps> = ({ onClose, isOpen }) => {
          ...
          <div className="flex-col justify-center items-start gap-[17px] flex w-full">
            <div>
              <strong className="text-[18px]">
                Chỉnh sửa "Đặc điểm nổi bật của Apolo Lawyers"
              </strong>
            </div>
