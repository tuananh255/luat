...
interface DeleteHumanResourcesProps {
  onClose?: () => void;
  isOpen?: boolean;
}

const DeleteHumanResources: React.FC<DeleteHumanResourcesProps> = ({
  onClose,
  isOpen,
}) => {
          ...
          <div className="flex-col justify-center items-start gap-[17px] flex w-full">
            <div>
              <strong className="text-[18px]">
                Bạn có chắc chắn xóa nhân sự này không ?
              </strong>
            </div>
...
export default DeleteHumanResources;
